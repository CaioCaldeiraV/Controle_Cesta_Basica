...
class ListBagWidget extends StatelessWidget {
  final RequestBasicBasketModel model;
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: FutureBuilder(
          future: repository.getBasicBasketName(model.basicbasketsId),
      ...
      subtitle: FutureBuilder(
          future: repository.getBasicBasketValue(model.basicbasketsId),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              if (snapshot.hasData) {
                return Text("""
